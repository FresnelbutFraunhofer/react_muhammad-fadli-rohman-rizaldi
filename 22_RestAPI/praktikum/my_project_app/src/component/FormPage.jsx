...
function FormPage() {
  ...
  const handleButtonClick = (e) => {
    ...
    const productType1 = productTypeRef1.current.checked
      ? productTypeRef1.current.value
      : null;
    const productType2 = productTypeRef2.current.checked
      ? productTypeRef2.current.value
      : null;
    const productType3 = productTypeRef3.current.checked
      ? productTypeRef3.current.value
      : null;
    ...
    if (
      !productTypeRef1.current.checked ||
      !productTypeRef1.current.checked ||
      !productTypeRef1.current.checked
    ) {
